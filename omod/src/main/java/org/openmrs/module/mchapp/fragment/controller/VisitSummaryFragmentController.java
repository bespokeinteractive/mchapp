...
public class VisitSummaryFragmentController {
	...
	public SimpleObject getVisitSummaryDetails(
		...
		SimpleObject detail = SimpleObject.fromObject(visitDetail, ui, "diagnosis", "symptoms", "cwcFollowUp", "cwcBreastFeedingExclussive","cwcBreastFeedingInfected", "cwcLLITN", "cwcDewormed", "cwcVitaminASupplementation", "cwcSupplementedWithMNP", "procedures", "investigations", "examinations", "pncCervicalScreeningMethod","pncCervicalScreeningResult", "hivPriorStatus", "hivPartnerStatus", "hivPartnerTested", "hivCoupleCouncelled", "pncExcercise","pncMultivitamin","pncVitaminA","pncHaematinics", "pncFamilyPlanning", "ancCouncelling", "ancExlussiveBF", "ancForInfected", "ancDecisionOnBF", "ancDeworming", "ancExcercise", "ancLLITN","visitOutcome", "internalReferral", "externalReferral");
