<%
    ui.decorateWith("appui", "standardEmrPage", [title: "Mother Child Health-Immunizations"])
...
<script type="text/javascript">
    var successUrl = "${ui.pageLink('patientqueueapp','mchTriageQueue')}";
...
<div class="mch-tabs" style="margin-top:5px!important;">
    <ul>
        <li id="cn"><a href="#immunizations">Immunizations</a></li>

    </ul>

    <div id="immunizations">
        ${ui.includeFragment("mchapp","cwcImmunizations", [patientId: patient.patientId])}
    </div>
